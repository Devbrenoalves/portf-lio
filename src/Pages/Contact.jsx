  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Tem alguma dúvida? Envie-me uma mensagem e responderei o mais breve possível.
        </p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Tem algo a falar? Envie-me uma mensagem e vamos conversar.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                {isSubmitting ? 'Mengirim...' : 'Enviar Mensagem'}
              </button>
            </form>
